    ...
    return (
        <section className="max-w-[860px] flex items-center justify-center flex-col mx-auto p-6 min-h-screen">
            <div className="flex flex-col justify-center px-4 mb-20 mt-10">
                ...
                <h2 className="text-2xl sm:text-[32px] font-bold mb-4 mt-16">Contact Us</h2>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <a target='_blank' href='https://twitter.com/bssfoss' className='socail-link'>
                        <FaTwitter className='w-7 h-7' />
                    </a>
                    <a target='_blank' rel='me' href='http://mas.to/@bssfoss' className='socail-link'>
