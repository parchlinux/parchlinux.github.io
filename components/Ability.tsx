            ...
            <div className="h-60 w-72 md:h-72 md:w-96 bg-[#f4f5f7] text-black rounded-2xl flex flex-col justify-center items-start p-4 gap-3">
              ...
              <p className="text-xl md:text-2xl">
                ...
                <a
                  ...
                  className="text-blue-500">تلگرام
                </a>{" "} انجمن فعال دارد که به سرعت مشکل شما را بررسی و برطرف میکند.اگر باگ یا مشکلی داشته باشید، میتوانید آن را در گروه گزارش دهید.
              </p>
            </div> :
            <div className="h-60 w-72 md:h-72 md:w-96 bg-[#f4f5f7] text-black rounded-2xl flex flex-col justify-center items-start p-4 gap-3">
              <div className="flex justify-start items-center gap-2">
